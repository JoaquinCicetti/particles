...
export default function DesignerCanvas() {
  ...
  return (
    ...
    >
      ...
      <fog attach="fog" args={['#070504', span * 3, span * 9]} />
      <hemisphereLight args={['#ffeedd', '#20150d', 1.2]} />
      <directionalLight position={[4, 10, 6]} intensity={1.5} color="#fff2e2" />
      <directionalLight position={[-6, 4, -5]} intensity={0.45} color="#c87f3d" />
      <RoomShell room={room} />
      {design.items.map((it) => (
