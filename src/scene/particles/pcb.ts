...
/**
 * The board is the SUBSTRATE and the logo (LOGO_CENTER_Y = 6.2, spanning
 * 4.6..7.8) is the destination ABOVE it. Raised from 2.9 and flattened from
 * HALF_H 2.7 so the board tops out below the mark with clear air between them:
 * that air is where the hand-off reads. Widened a little to keep a board-like
 * aspect now that it is shallower.
 */
export const PCB_CENTER_Y = 3.2
